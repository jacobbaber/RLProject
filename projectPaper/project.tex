...
\section*{1. Domain}
The domain of our project is the popular game Tic-Tac-Toe. It is a two player game where each player will take turns playing down their individual symbol on a 3x3 grid, and the first player to connect three of their symbols in a row wins.
